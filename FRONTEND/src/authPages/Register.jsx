  ...
  return (
    <div className='pt-20 h-dvh flex items-center justify-center dark:bg-neutral-950 bg-neutral-100 transition **:transition duration-150'>
      ...
      <div className='flex flex-col gap-12'>
        <p className='text-3xl dark:text-white font-black'>Create a new account</p>

        <div className='flex flex-col gap-2'>

          <div className="relative">
            <HiOutlineUser size={20} className="text-neutral-500 dark:text-neutral-600 absolute top-2.5 left-2"/>
            <input className='dark:bg-neutral-900 w-full pl-9 bg-neutral-200 rounded-xl p-2 dark:text-white placeholder-neutral-500 dark:placeholder-neutral-600 outline-none' placeholder='First Name' type="text" />
          </div>
          ...
          <div className="relative">
            <HiOutlineLockClosed size={20} className="text-neutral-500 dark:text-neutral-600 absolute top-2.5 left-2"/>
            <input className='dark:bg-neutral-900 w-full pl-9 bg-neutral-200 rounded-xl p-2 dark:text-white placeholder-neutral-500 dark:placeholder-neutral-600 outline-none' placeholder='Confirm Password' type={pwVis ? "text" : "password"} />
          </div>
          ...
          <button className='p-2  dark:text-black bg-black dark:bg-white text-white rounded-xl cursor-pointer hover:opacity-90'>Register</button>
        </div>

        <Link to="/login-with-email" className="flex gap-2 items-center justify-center dark:text-neutral-500"><HiOutlineUser/>Already registered? Log in instead.</Link>
      </div>
    </div>
  )
}
