...
const BlogTile = ({
  ...
  return (
    ...
    <div className="box-border relative p-4 rounded-2xl overflow-hidden my-2 mx-2 transition duration-200 hover:-translate-y-3 hover:scale-101 hover:scale-y-103 active:scale-100">
      <div style={{backgroundImage: `url(${API_BASE + image})`, backgroundPosition:"center", backgroundRepeat:"no-repeat", backgroundSize:"cover"}} className="absolute brightness-20 hover:brightness-70 top-0 left-0 right-0 bottom-0 z-0 transition duration-300">
      </div>
